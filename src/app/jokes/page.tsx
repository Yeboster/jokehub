  ...
  if (!user) {
    return (
      <div className="container mx-auto p-4 md:p-8 text-center flex flex-col items-center justify-center min-h-[calc(100vh-10rem)]">
        ...
        <h1 className="text-3xl font-bold mb-2">Your Joke Collection</h1>
        ...
        <Button asChild size="lg">
          <Link href="/auth?redirect=/jokes">Get Started</Link>
        </Button>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <header className="mb-8 text-center">
        <h1 className="text-4xl font-bold tracking-tight text-primary sm:text-5xl">Your Jokes</h1>
        <p className="mt-3 text-lg text-muted-foreground sm:text-xl">Browse, filter, and add to your hilarious collection.</p>
      </header>
